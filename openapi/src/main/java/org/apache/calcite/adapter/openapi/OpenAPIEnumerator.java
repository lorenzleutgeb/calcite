...
class OpenAPIEnumerator<E> implements Enumerator<E> {
    ...
    public OpenAPIEnumerator(String sourceURL, AtomicBoolean cancelFlag, Model entityModel, List<String> order, int[] fields,
...
//                    return node.toString();
    ...
    static class ArrayRowConverter extends RowConverter<Object[]> {
        ...
        @Override
        Object[] convertRow(JsonNode currentNode) {
